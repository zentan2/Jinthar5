...
const AddRemove = () => {
  ...
  let handleSubmitAdd = async (e) => {
    ...
    try {
      let res = await fetch(
        "http://linuxapacgtcb46.conygre.com:8081/portfolio/add",
        {
          method: "POST",
  ...
  let handleSubmitRemove = async (e) => {
    ...
    try {
      let res = await fetch(
        "http://linuxapacgtcb46.conygre.com:8081/portfolio/delete",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  let handleSubmitEdit = async (e) => {
    ...
    try {
      let res = await fetch(
        "http://linuxapacgtcb46.conygre.com:8081/portfolio/update",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
